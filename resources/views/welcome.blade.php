...
<div class="container">
	...
	<div class="content-wrapper">
		<div class="intro">
			...
			<span class="big wow pulse" data-wow-duration="1s" data-wow-delay="0s">Maquillaje</span><br/>
    ...
    <section class="background">
        <div class="content-wrapper">
            <div class="intro">
                <h1><span class="smaller wow zoomIn" data-wow-duration="2s" data-wow-delay="0.5">1044 Madison Avenue, New York, NY 10075, US</span>
                <span class="big wow pulse" data-wow-duration="1s" data-wow-delay="0s">Vestuario</span><br/>
                <span class="small wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s">- - -</span>
                </h1>
            </div>
        </div>
...
<script src="js/index/testimonials.js"></script>
